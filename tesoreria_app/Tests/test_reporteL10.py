...
'''
Ejecución: 
python .\manage.py test -v3 app_rdml.Tests.test_reporteL10
'''
class Test_ReporteL10(unittest.TestCase):
    ...
    def test_validarIntegridad_1(self):
        RUTA_MIA = self.RUTA_BASE_MIA + "L10_1390067506001_2023-02-28.xlsx"
        RUTA_EXTERNA = self.RUTA_BASE_EXTERNO + "L10_2023-02-28.xlsx"
        ...
        realizarComparacionDatraframes("Análisis L10", df1, df2)
        pd.testing.assert_frame_equal(df1, df2)


    def test_validarIntegridad_2(self):
        RUTA_MIA = self.RUTA_BASE_MIA + "L10_1390067506001_2023-03-31.xlsx"
        RUTA_EXTERNA = self.RUTA_BASE_EXTERNO + "L10_2023-03-31.xlsx"
